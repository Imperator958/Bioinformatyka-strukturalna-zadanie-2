...
def plot_ramachandran(phi_values, psi_values, secondary_structure):
    ...
    for phi, psi, secondary in zip(phi_values, psi_values, secondary_structure):    # zip -> łączenie w pary elementów
        plt.scatter(phi, psi, s=10, color=color_map[secondary])                     # rysowanie pojedyńczych punktów
